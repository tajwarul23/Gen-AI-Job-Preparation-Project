      ...
      <div className="p-5">
        ...
        {report && reportStatus === "generated" && (
          <div className="flex flex-col gap-5">
            {/* AI badge */}
            <div className="flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider text-violet">
            ...
            {report.executiveSummary && (
              <div>
                <p className="mb-2 flex items-center gap-2 text-sm font-mono uppercase tracking-wider text-muted">
            ...
            {report.hiringRecommendation && (
              <div className="rounded-xl border border-violet/20 bg-violet/5 p-4">
                <p className="mb-2 flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider text-violet">
